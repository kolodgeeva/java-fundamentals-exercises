...
public class Functions {
    ...
    public static FunctionMap<Integer, Integer> intFunctionMap() {
        ...
        intFunctionMap.addFunction("increment", value -> ++value);
        intFunctionMap.addFunction("decrement", value -> --value);
        intFunctionMap.addFunction("square", value -> (int) Math.pow(value, 2));
